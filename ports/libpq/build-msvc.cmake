function(build_msvc build_type source_path)
    ...
    endforeach()
    foreach(option IN ITEMS icu lz4 nls python tcl xml xslt zlib zstd)
        if(option IN_LIST FEATURES)
            string(APPEND config "\$config->{${option}} = \"${CURRENT_INSTALLED_DIR}\";\n")
        endif()
    endforeach()
    string(APPEND config "\$config->{openssl} = \"${CURRENT_INSTALLED_DIR}\";\n")
    string(APPEND config "\$config->{openssl_version} = '1.1.1';\n")
